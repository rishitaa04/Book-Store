  ...
  return (
    <div className='h-[75vh] flex flex-col md:flex-row items-center justify-center'>
        ...
        <p className='mt-4 text-xl text-zinc-300 text-center lg:text-left'>
            Uncover captivating stories, encriching knowledge, and endless inspiration in our curated collection of books
        </p>
        <div className='mt-8'>
        <Link 
        to ="/all-books"
        ...
        <div className='w-full lg:w-3/6 -auto lg:h-[100%] flex items-center justify-center'>
